...
# --- DİNAMİK YOL DÜZELTMESİ (Streamlit Cloud Modül Hatasını Çözer) ---
# Projenin ana dizinini (kök klasörü) Python'un modül arama yoluna ekler
...
if st.session_state.optimization_completed:
    ...
    show_route_map(st.session_state.dataset, st.session_state.route)import streamlit as st
